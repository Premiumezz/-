...
local TweenService = game:GetService("TweenService")local input = game:GetService("UserInputService")
for i,v in next, game.CoreGui:GetChildren() do    if v:IsA("ScreenGui") and v.Name == "Neverlose" then        v:Destroy()    endend
local themouse = game.Players.LocalPlayer:GetMouse()
local function Notify(tt, tx)    game:GetService("StarterGui"):SetCore("SendNotification", {        Title = tt,        Text = tx,        Duration = 5    })end
local function Dragify(frame, parent)    parent = parent or frame    local dragging = false    local dragInput, mousePos, framePos
...
local function round(num, bracket)    bracket = bracket or 1    local a = math.floor(num/bracket + (math.sign(num) * 0.5)) * bracket    if a < 0 then        a = a + bracket    end    return aend
local function buttoneffect(options)    pcall(function()        options.entered.MouseEnter:Connect(function()            if options.frame.TextColor3 ~= Color3.fromRGB(234, 239, 246) then                TweenService:Create(options.frame, TweenInfo.new(0.06, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {                    TextColor3 = Color3.fromRGB(234, 239, 245)                }):Play()            end        end)        options.entered.MouseLeave:Connect(function()            if options.frame.TextColor3 ~= Color3.fromRGB(157, 171, 182) and options.frame.TextColor3 ~= Color3.fromRGB(234, 239, 246) then                TweenService:Create(options.frame, TweenInfo.new(0.06, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {                    TextColor3 = Color3.fromRGB(157, 171, 182)                }):Play()            end        end)    end)end
local function clickEffect(options)    options.button.MouseButton1Click:Connect(function()        local new = options.button.TextSize - tonumber(options.amount)        local revert = new + tonumber(options.amount)        TweenService:Create(options.button, TweenInfo.new(0.15, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {TextSize = new}):Play()        wait(0.1)        TweenService:Create(options.button, TweenInfo.new(0.1, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {TextSize = revert}):Play()    end)end
function Library:Toggle(value)    if game:GetService("CoreGui"):FindFirstChild("Neverlose") == nil then return end    enabled = (type(value) == "boolean" and value) or game:GetService("CoreGui"):FindFirstChild("Neverlose").Enabled    game:GetService("CoreGui"):FindFirstChild("Neverlose").Enabled = not enabledend
function Library:Window(options)    options.text = options.text or "NEVERLOSE"
...
function tabsections:TabSection(options)
    ...
    function tabs:Tab(options)
        ...
        tabIcon.Position = UDim2.new(0.0608859849, 0, 0.133333355, 0)
        ...
        function sections:Section(options)
            ...
            function elements:Button(options)
                ...
                TextButton.Size = UDim2.new(0, 195, 0, 22)
            ...
            function elements:Toggle(options)
                ...
                toggleLabel.Size = UDim2.new(0, 195, 0, 22)
            ...
            function elements:Slider(options)
                ...
                Slider.Size = UDim2.new(0, 195, 0, 22)
                ...
                sliderFrame.Position = UDim2.new(1.3, 0, 0.5, 0)
                ...
                sliderTextBox.Position = UDim2.new(2.1, 0, 0.5, 0)
            ...
            function elements:Dropdown(options)
                ...
                Dropdown.Size = UDim2.new(0, 195, 0, 22)
                Dropdown.ZIndex = 2
                ...
                dropdownLabel.Position = UDim2.new(0.02, 0, 0, 0)
                dropdownLabel.Size = UDim2.new(0, 100, 0, 22)
                ...
                dropdownText.Position = UDim2.new(1.3, 0, 0.0909090936, 0)
                dropdownText.Size = UDim2.new(0, 80, 0, 18)
                ...
                dropdownArrow.MouseButton1Click:Connect(function()
                    ...
                    if Dropped then
                        ...
                        TweenService:Create(dropdownList, TweenInfo.new(0.06, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                            Size = UDim2.new(0, 80, 0, DropYSize)
                        }):Play()
                        TweenService:Create(dropdownList, TweenInfo.new(0.06, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                            BorderSizePixel = 1
                        }):Play()
                ...
                for i,v in next, options.list do
                    ...
                    dropdownBtn.Size = UDim2.new(0, 80, 0, 18)
            ...
            function elements:Textbox(options)
                ...
                Textbox.Size = UDim2.new(0, 195, 0, 22)
                ...
                textBoxLabel.Position = UDim2.new(0.02, 0, 0, 0)
                textBoxLabel.Size = UDim2.new(0, 100, 0, 22)
            ...
            function elements:Colorpicker(options)
                ...
                Colorpicker.Size = UDim2.new(0, 195, 0, 22)
                ...
                colorpickerLabel.Position = UDim2.new(0.02, 0, 0, 0)
                colorpickerLabel.Size = UDim2.new(0, 195, 0, 22)
                ...
                colorpickerButton.Position = UDim2.new(0.95, 0, 0.57, 0)
            ...
            function elements:Keybind(options)
                ...
                Keybind.Size = UDim2.new(0, 195, 0, 22)
                Keybind.ZIndex = 2
                ...
                keybindButton.Position = UDim2.new(0.02, 0, 0, 0)
                keybindButton.Size = UDim2.new(0, 195, 0, 22)
